		...
		{#if $user?.role === 'admin'}
			<div class="px-2 flex justify-center mt-0.5">
				<a
					...
					href="https://sreejithshr-command-r-plus-online.hf.space/"
				>
					<div class="self-center">
						<img class= h-4 src= "https://cdn.glitch.global/11c5ec7d-52af-42a7-a718-7c013a91eeaa/translater.png?v=1714907156429">
					</div>

					<div class="flex self-center">
						<div class=" self-center font-medium text-sm">Multi lingual Chat</div>
					</div>
				</a>
			</div>
